...
const ThreeCards = () => {
    return (
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-5 my-10">
            ...
            {/* take advice card */}
            <Link to="/advice">
                <div className="rounded-md w-full h-[100px] flex justify-center items-center bg-[#003049] font-semibold text-white text-2xl md:text-xl lg:text-2xl gap-1 p-1 cursor-pointer">
            ...
            <div className="rounded-md w-full h-[100px] flex justify-center items-center bg-[#003049] font-semibold text-white text-2xl md:text-xl lg:text-2xl p-1 cursor-pointer">
