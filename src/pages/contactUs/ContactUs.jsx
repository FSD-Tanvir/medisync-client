          ...
          <div className="flex-1">
            ...
            <div className="px-1">
              <form ref={form} onSubmit={sendEmail}>
                <input type="text" placeholder="Your Name" className="border border-blue-500 w-full lg:w-3/4 focus:outline-blue-500 focus:outline px-3 py-2 my-5" name="user_name" />
                <input type="email" placeholder="Your Email" className="border border-blue-500 w-full lg:w-3/4 focus:outline-blue-500 focus:outline px-3 py-2 " name="user_email" />
                <textarea name="message" placeholder="Write here your message" className="border border-blue-500 w-full lg:w-3/4 focus:outline-blue-500 focus:outline px-3 py-2 my-5" />
                <input type="submit"
                  className="border capitalize rounded-md hover:border-hover-border-color hover:text-hover-text-color font-semibold py-2 shadow-[-2px_-2px_12px_2px_rgba(0,0,0,0.1),_2px_2px_12px_2px_rgba(0,0,0,0.1)] bg-button-bg-color text-white hover:bg-button-bg-hover-color transition duration-[250] ease-linear w-full lg:w-3/4 " value="Send" />
              </form>
            </div>
          </div>
        </div>
