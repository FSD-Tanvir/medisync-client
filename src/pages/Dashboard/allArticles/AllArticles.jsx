...
const AllArticles = () => {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await axiosPublic.delete(`/newAndArticles/deleteArticle/${id}`)
                .then(res => {
    ...
    return (
                    ...
                    <table className="w-full ">
                        ...
                        <tbody>
                            {articles.map((article, index) => (
                                <tr key={article.id} className="bg-white shadow-lg sm:shadow-none mb-6 sm:mb-0 cursor-pointer hover:bg-gray-100  hover:-gray-600">
       ...
       <ArticleUpdate clickAbleId={clickAbleId} showModal={showModal} setShowModal={setShowModal}></ArticleUpdate>
       </div>
    );
};
