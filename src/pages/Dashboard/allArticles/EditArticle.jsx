...
const EditArticle = () => {
  ...
  return (
    ...
    //           <button className="border hover:border-blue-500 hover:text-blue-500 font-semibold py-3 px-8 rounded-md text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm lg:w-full xl:w-fit  shadow-[-2px_-2px_12px_2px_rgba(0,0,0,0.1),_2px_2px_12px_2px_rgba(0,0,0,0.1)]   bg-blue-500 text-white hover:bg-[#FFF7F4]">
    //             Submit
    //           </button>
    //         </div>
    //       </form>
